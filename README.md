# Вариант 33 — Метод бисекции на RISC‑V (RARS 1.6). Оценка 10/10
...
Найти корень уравнения $f(x)=x^3-\frac{1}{2}x^2+0.2x-4=0$ методом бисекции с точностью $\varepsilon \in [10^{-8};\,10^{-3}]$.

Базовый интервал — $[1,3]$. Если пользователь вводит интервал без смены знака (нет бракета), программа автоматически подбирает корректный интервал.
